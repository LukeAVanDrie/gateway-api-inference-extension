...
func (d *Director) HandleRequest(ctx context.Context, reqCtx *handlers.RequestContext) (*handlers.RequestContext, error) {
	...
	candidatePods := d.toSchedulerPodMetrics(d.podLocator.Locate(ctx, reqCtx.Request.Metadata))

	// Prepare per request data by running PrepareData plugins.
	if d.runPrepareDataPlugins(ctx, reqCtx.SchedulingRequest, candidatePods) != nil {
	...
	if !d.runAdmissionPlugins(ctx, reqCtx.SchedulingRequest, candidatePods) {
