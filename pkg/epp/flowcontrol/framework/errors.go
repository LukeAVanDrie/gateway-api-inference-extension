...
//
// These are returned by `SafeQueue` methods and might be handled or wrapped by the `ports.FlowRegistry`'s
// `ports.ManagedQueue` or the `controller.FlowController`.
var (
