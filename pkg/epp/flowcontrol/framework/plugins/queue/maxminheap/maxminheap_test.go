...
// TestMaxMinHeap_InternalProperty validates that the max-min heap property is maintained
// after a series of Add and Remove operations. This is a white-box test to ensure
// the internal data structure is always in a valid state.
